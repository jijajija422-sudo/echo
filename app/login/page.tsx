...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!success) {
      setError('Invalid email or password. Try jija@example.com / password123');
    }
    setIsLoading(false);
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-4">
            <div className="w-12 h-12 rounded-2xl bg-slate-900 flex items-center justify-center p-2">
          ...
          <p className="text-slate-500 mt-2">Sign in to your Echo account</p>
        </div>
        ...
        <div className="bg-white rounded-3xl border border-slate-200 shadow-xl p-8">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-4 py-3 border border-slate-200 rounded-2xl hover:bg-slate-50 transition font-semibold text-slate-700 mb-4"
          >
          ...
          <form onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full py-3 bg-slate-900 text-white rounded-xl font-bold text-sm hover:bg-slate-800 transition flex items-center justify-center gap-2 disabled:opacity-50"
            >
